    ...
    ERC4907
{
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721, ERC721Enumerable, ERC721URIStorage, ERC4907)
        returns (bool)
    {
    ...
    function setUser(
        ...
        uint256 expiryTime = _users[tokenId].expires;
        if (expiryTime > 0) {
            require(block.timestamp > expiryTime, "setUser: Already in rental");
        }
